# Ridge Time Step Classifier in Scikit-learn

Ridge Time Step Classification Model in Scikit-learn as per Ready Tensor specifications.
...
- A **Ridge Time Step Classification** model built using **Scikit-learn**
